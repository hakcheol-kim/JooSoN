...
- (void)makeData {
    ...
    NSDictionary *itemDic = [NSDictionary dictionaryWithObjectsAndKeys:@"네이버 지도", @"mapName", MapIdNaver, @"mapId",  nil];
    [arrSection addObject:itemDic];
    
    itemDic = [NSDictionary dictionaryWithObjectsAndKeys:@"구글 지도", @"mapName", MapIdGoogle, @"mapId",  nil];
    [arrSection addObject:itemDic];
    
    itemDic = [NSDictionary dictionaryWithObjectsAndKeys:@"카카오맵", @"mapName", MapIdKakao, @"mapId",  nil];
    [arrSection addObject:itemDic];
