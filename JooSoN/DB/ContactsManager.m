...
+ (void)checkContactWidthCompetion:(void (^)(BOOL success, NSError *error))completion {
    if ([CNContactStore class]) {
        ...
        if ([CNContactStore authorizationStatusForEntityType:entityType] == CNAuthorizationStatusNotDetermined) {
            ...
            NSError *err = [[NSError alloc] initWithDomain:NSCocoaErrorDomain code:100 userInfo:@{@"msg": @"CNAuthorizationStatusDenied"}];
